...
enum Row: String {
    ...
    init(row: Int) {
        ...
        case 1: self = .home //messages
        case 2: self = .flights
        case 3: self = .hotels
        case 4: self = .cars
        case 5: self = .about_us
        case 6: self = .contact_us
        default: self = .none
        }
    }
}
...
class SidebarView: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    override init(frame: CGRect) {
        ...
        titleArr = [ " ", "Home", "Flights", "Hotels", "Cars", "About us", "Contact us"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cellImg = UIImageView(frame: CGRect(x: 10, y: 10, width: 230, height: 55))
            ...
            let cellLbl = UILabel(frame: CGRect(x: 110, y: cell.frame.height/2-15, width: 250, height: 20))
